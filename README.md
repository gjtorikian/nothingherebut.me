...
Nothing Here But Me is just a little experiment in storytelling.
...
The "artistic intent" here is to play with people's obsession with checking the same websites over and over. In this case, the content changes imperceptibly as you watch it over the course of the day, but it is most legible when you make frequent visits.
...
What's _not_ available is the actual story itself. Providing that full text would sort of default the purpose of the project. The file _text.sample.yml_ provides a rough outline of that that file looks like. Feel free to add your own text and rename it to _text.yml_ to watch it render.
